...
<head>
    ...
    <title>Novo Vendedor - OSFacil</title>
...
<body class="bg-gradient-to-br from-slate-50 via-white to-slate-50 min-h-screen">
    ...
    <a href="/vendedor/listar" class="fixed top-6 right-8 z-50 inline-flex items-center px-4 py-2.5 bg-white text-slate-700 rounded-lg hover:bg-slate-50 transition-all duration-300 shadow-lg hover:shadow-xl border border-slate-200 group">
    ...
    <main class="ml-64 p-8">
        ...
        <div class="mb-8 fade-in">
            <h2 class="text-3xl font-semibold text-slate-800 mb-2">Novo Vendedor</h2>
            <p class="text-slate-500">Cadastre um membro da equipe</p>
        </div>
        
        <!-- Form -->
        <div class="max-w-3xl mx-auto bg-white rounded-xl shadow-sm border border-slate-100 p-8 fade-in">
            <form action="/vendedor/salvar" method="POST" class="space-y-6">
                <!-- Nome -->
                <div>
                    ...
                    <input type="text" name="nome" required
                        class="w-full border border-slate-200 rounded-lg px-4 py-3 focus:ring-2 focus:ring-violet-400 focus:border-transparent transition-all outline-none"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label class="flex items-center text-sm font-medium text-slate-700 mb-2">
                            ...
                            Telefone <span class="text-red-500 ml-1">*</span>
                        </label>
                        <input type="text" name="telefone" required
                            class="w-full border border-slate-200 rounded-lg px-4 py-3 focus:ring-2 focus:ring-violet-400 focus:border-transparent transition-all outline-none"
                            placeholder="(15) 99777-6655">
                    </div>
                    ...
                    <div>
                        <label class="flex items-center text-sm font-medium text-slate-700 mb-2">
                            ...
                            CPF <span class="text-red-500 ml-1">*</span>
                        </label>
                ...
                <div>
                    <label class="flex items-center text-sm font-medium text-slate-700 mb-2">
                        ...
                        Data de Admissão <span class="text-red-500 ml-1">*</span>
                    </label>
                ...
                <div>
                    ...
                    <textarea name="observacoes" rows="4"
                        class="w-full border border-slate-200 rounded-lg px-4 py-3 focus:ring-2 focus:ring-violet-400 focus:border-transparent transition-all outline-none resize-none"
                        placeholder="Informações adicionais sobre o vendedor..."></textarea>
                </div>

                <!-- Buttons -->
                <div class="flex justify-end pt-6 border-t border-slate-100">
                    <button type="submit"
                        class="inline-flex items-center px-8 py-3 bg-violet-500 text-white rounded-lg hover:bg-violet-600 transition-all duration-300 shadow-sm hover:shadow-md font-medium">
